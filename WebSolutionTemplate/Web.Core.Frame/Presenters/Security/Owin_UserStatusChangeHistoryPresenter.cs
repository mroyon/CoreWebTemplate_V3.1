...
namespace Web.Core.Frame.Presenters
{
    ...
    /// </summary>
    public sealed class Owin_UserStatusChangeHistoryPresenter : IOutputPort<Owin_UserStatusChangeHistoryResponse>, ICRUDRequestHandler<Owin_UserStatusChangeHistoryResponse>
    {
        /// <summary>
        /// ContentResult
        /// </summary>
