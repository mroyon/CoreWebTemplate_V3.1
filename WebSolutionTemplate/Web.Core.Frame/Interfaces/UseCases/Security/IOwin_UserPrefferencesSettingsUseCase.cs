...
{
    public interface IOwin_UserPrefferencesSettingsUseCase : IUseCaseRequestHandler<Owin_UserPrefferencesSettingsRequest, Owin_UserPrefferencesSettingsResponse>
    {
