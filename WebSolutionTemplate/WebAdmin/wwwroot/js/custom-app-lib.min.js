 ...
 * Date: 2021-03-02T17:08Z
 */
$(function(){$("body").on("click","#ahrefchange_password",function(){ajaxGetHandler("/Account/ChangePassword",{returnUrl:"/"},function(n){_cusTriggerModal("modal-common",n)},!1,!1)});$("body").on("click","#btn-common-modal-close",function(n){try{n.preventDefault();_cusCloseModal("modal-common")}catch(t){showErrorAlert("Error",t.message,"OK")}});$("body").on("click","#btnchangepassword",function(n){try{event.preventDefault();_cusFormValidate("frmchangepassword")&&ajaxPostObjectHandler("/Account/ChangePassword",null,function(n){n!=="INVALID_PARAMETERS"&&showSuccessAlert("Success",n.response,"OK")},!1)}catch(n){showErrorAlert("Error",n.message,"OK")}})});
/*!
 ...
 * Date: 2021-03-02T17:08Z
 */
dir=$("html").attr("dir");$.extend(!0,$.fn.dataTable.defaults,{lengthMenu:[[10,25,50,100,200],[10,25,50,100,200]],bDestroy:!0,processing:!0,serverSide:!0,filter:!0,orderMulti:!1,responsive:!0,bAutoWidth:!1,autoWidth:!1,pagingType:"simple_numbers",stripeClasses:[],dom:'<"row w-100  mb-3"<"col-lg-12"B>><"row   mb-3"<"col-lg-12">><"row w-100 "<"col-lg-2"l><"col-lg-7"><"col-lg-2"f>>rt<"row w-100"<"col-lg-6"i><"col-lg-6 text-center"p>>',buttons:["print","copy","excel","pdf"],language:{url:dir=="rtl"?"//cdn.datatables.net/plug-ins/1.10.20/i18n/Arabic.json":"",processing:"<div class='overlay custom-loader-background'><i class='fa fa-cog fa-spin custom-loader-color'><\/i><\/div>",infoFiltered:""},drawCallback:function(){Math.ceil(this.fnSettings().fnRecordsDisplay()/this.fnSettings()._iDisplayLength)>1?$("#Dt_paginate").css("display","block"):$("#Dt_paginate").css("display","none")}});$.fn.DataTable.ext.pager.numbers_length=4;$.fn.dataTable.json=function(n){var t=$.extend({pages:10,url:"",data:null,method:"POST"},n);return function(n,i,r){var f=n.start,e=n.length,u;!0&&(n.start=f,n.length=e,$.isFunction(t.data)?(u=t.data(n),u&&$.extend(n,u)):$.isPlainObject(t.data)&&$.extend(n,t.data),r.jqXHR=$.ajax({type:t.method,url:t.url,data:n,dataType:"json",cache:!1,beforeSend:function(n){n.setRequestHeader("X-CSRF-TOKEN-WEBADMINHEADER",$("#X-CSRF-TOKEN-WEBADMINHEADER").val())},success:function(n){i(n)}}))}};