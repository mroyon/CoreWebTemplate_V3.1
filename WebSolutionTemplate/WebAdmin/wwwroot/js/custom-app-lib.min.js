 ...
 * Date: 2021-03-02T17:08Z
 */
$(function(){$("body").on("click","#ahrefchange_password",function(){ajaxGetHandler("/Account/ChangePassword",{returnUrl:"/"},function(n){_cusTriggerModal("modal-common",n)},!1,!1)});$("body").on("click","#btn-common-modal-close",function(n){try{n.preventDefault();_cusCloseModal("modal-common")}catch(t){showErrorAlert("Error",t.message,"OK")}});$("body").on("click","#btnchangepassword",function(n){try{if(event.preventDefault(),_cusFormValidate("frmchangepassword")){var t={emailaddress:$("#emailaddress").val(),password:$("#password").val(),newpassword:$("#newpassword").val(),confirmpassword:$("#confirmpassword").val()};ajaxPostObjectHandler("/Account/ChangePasswordPost",t,function(){_cusCloseModal("modal-common")},!0)}}catch(n){showErrorAlert("Error",n.message,"OK")}})});
/*!
