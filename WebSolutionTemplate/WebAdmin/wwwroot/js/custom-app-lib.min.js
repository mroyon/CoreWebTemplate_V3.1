 ...
 * Date: 2021-03-02T17:08Z
 */
$(function(){$("body").on("click","#ahrefchange_password",function(){ajaxGetHandler("/Account/ChangePassword",{returnUrl:"/"},function(n){_cusTriggerModal("modal-common",n)},!1,!1)});$("body").on("click","#btn-common-modal-close",function(n){try{n.preventDefault();_cusCloseModal("modal-common")}catch(t){showErrorAlert("Error",t.message,"OK")}});$("body").on("click","#btnchangepassword",function(n){try{event.preventDefault();_cusFormValidate("frmchangepassword")&&ajaxPostObjectHandler("/Account/ChangePassword",null,function(n){n!=="INVALID_PARAMETERS"?showSuccessAlert("Success",n.response,"OK"):alert("There is a problem on server side. Please try again later.")},!1)}catch(n){showErrorAlert("Error",n.message,"OK")}})});